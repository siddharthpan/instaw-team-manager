...
const structure = [
  ...
  { id: 1, label: 'Inventory', link: '/app/inventory', icon: <TypographyIcon /> },
  { id: 2, label: 'EOX', link: '/app/eox', icon: <TableIcon /> },
  { id: 3, label: 'Contracts', link: '/app/contracts', icon: <NotificationsIcon />},
  {
    id: 4,
    label: 'UI Elements',
    link: '/app/ui',
